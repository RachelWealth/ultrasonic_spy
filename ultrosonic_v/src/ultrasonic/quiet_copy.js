 ...
 */
console.log("Here is quiet_copy.js");
/** @namespace */
// class Quiet {
...
//     static mpleBufferSize = 16384;

//     // initialization flags
//     static emscriptenInitialized = false;
//     static profilesFetched = false;
//     static memoryInitializerPrefix = "";
...
//     static readyErrbacks = [];
//     static failReason = "";

//     // these are used for receiver only
//     static gUM;
//     static audioInput;
//     static audioInputFailedReason = "";
//     static audioInputReadyCallbacks = [];
//     static audioInputFailedCallbacks = [];
//     static frameBufferSize = Math.pow(2, 14);

//     // anti-gc
//     static receivers = {};
//     static receivers_idx = 0;
...
//     onEmscriptenInitialized() {
//         emscriptenInitialized = true;
//         checkInitState();
//     };

//     onEmscriptenLocateFile(path, prefix) {
...
//     setMemoryInitializerPrefix(prefix) {
//         memoryInitializerPrefixURL = prefix;
//     };

//    setLibfecPrefix(prefix) {
...
//         var frame_len = 100; //according to https://quiet.github.io/quiet-js/
//         /*if (opts.clampFrame) {
...
//    addAudioInputReadyCallback(c, errback) {
//         if (errback !== undefined) {
